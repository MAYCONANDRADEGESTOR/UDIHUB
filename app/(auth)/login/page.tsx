      ...
      <form onSubmit={handleEmailLogin} className="space-y-3">
        <div>
          ...
          <input
            ...
            required
            className="w-full px-4 py-3 rounded-xl text-sm text-foreground placeholder-muted transition-all duration-200"
            style={{
              background: "#111113",
              border: "1px solid #1F1F23",
              outline: "none",
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              placeholder="••••••••"
              required
              className="w-full px-4 py-3 rounded-xl text-sm text-foreground placeholder-muted transition-all duration-200 pr-11"
              style={{
                background: "#111113",
                border: "1px solid #1F1F23",
                outline: "none",
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full py-3.5 rounded-xl font-bold text-sm text-white transition-all duration-200 flex items-center justify-center gap-2 mt-2"
          style={{
            background: "linear-gradient(135deg, #3B82F6, #1d4ed8)",
