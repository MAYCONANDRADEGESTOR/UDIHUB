...
export default function ContaSuspensaPage() {
  return (
    ...
    >
      ...
      <h1 className="font-syne font-extrabold text-2xl text-foreground mb-3">
        Conta suspensa
      </h1>
      ...
      {/* Contact */}
        ...
        href="mailto:Udihub@outlook.com?subject=Revisão de suspensão de conta"
        className="flex items-center gap-2 px-6 py-3 rounded-xl font-bold text-sm text-white mb-4 transition-all duration-200"
        style={{
      ...
      {/* Info box */}
      <div
        className="mt-10 p-4 rounded-2xl max-w-xs text-left"
        style={{ background: "#111113", border: "1px solid rgba(239,68,68,0.2)" }}
      >
        <p className="text-xs font-bold mb-2" style={{ color: "#f87171" }}>
          Motivos comuns de suspensão:
        </p>
        <ul className="space-y-1">
          {[
            "Número de WhatsApp inválido ou falso",
            "Avaliações fraudulentas",
            "Informações enganosas no perfil",
