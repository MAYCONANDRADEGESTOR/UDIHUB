...
export default function ComoFuncionaPage() {
  return (
    <div className="min-h-screen bg-background pb-24">
      {/* Header */}
      <div
        className="sticky top-0 z-40 px-4 h-14 flex items-center"
        style={{
      ...
      <div className="px-4 py-6 space-y-10 max-w-lg mx-auto">
        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              ...
              { icon: Search, step: "02", title: "Busque por categoria", desc: "Escolha o tipo de serviço: encanador, eletricista, diarista e muito mais. 23 categorias disponíveis." },
        ...
        <section>
          ...
          <div className="space-y-3">
            {[
              { icon: CheckCircle, title: "Cadastro rápido", desc: "Crie seu perfil em minutos: nome, especialidade, bairros atendidos, WhatsApp e bio." },
              { icon: CreditCard, title: "Escolha o plano", desc: "Plano Básico (R$69/mês) ou Pro (R$99/mês). Pagamento via PIX ou cartão pelo Asaas." },
              { icon: MessageCircle, title: "Receba leads", desc: "Clientes da sua cidade e bairro entram em contato direto pelo WhatsApp." },
        ...
        <div className="flex flex-col gap-3">
          <Link href="/servicos" className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-sm text-white"
          ...
          <Link href="/seja-profissional" className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-semibold text-sm"
