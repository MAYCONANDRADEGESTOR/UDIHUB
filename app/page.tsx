      ...
      <section className="relative pt-28 pb-16 px-4 overflow-hidden"
        ...
        <div className="max-w-xl mx-auto text-center relative z-10">
          ...
          <div className="flex justify-center mb-6">
            <Image src="/logo.png" alt="UDIHUB" width={80} height={80} className="rounded-2xl object-cover"
              style={{ boxShadow: "0 0 40px rgba(139,92,246,0.4)" }} />
          </div>

          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-bold mb-6 tracking-wide"
      ...
      <section className="px-4 py-14">
        <div className="max-w-2xl mx-auto">
          <div className="flex items-end justify-between mb-6">
            ...
            <Link href="/servicos" className="flex items-center gap-1 text-sm font-semibold" style={{ color: "#3B82F6" }}>
          ...
          <div className="grid grid-cols-4 gap-2.5">
            {HERO_CATEGORIES.map((cat) => (
              <Link key={cat.slug} href={`/servicos/${cat.slug}`}
                ...
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-xl group-hover:scale-110 transition-transform duration-200"
                  style={{ background: "rgba(59,130,246,0.08)" }}>
                  {cat.icon}
                </div>
                <span className="text-[10px] leading-tight font-semibold" style={{ color: "#64748b" }}>
          ...
          <Link href="/servicos"
            className="mt-3 w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl text-sm font-semibold"
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="flex flex-col gap-4">
            {HOW_IT_WORKS.map(({ step, icon: Icon, title, desc, color }) => (
              <div key={step} className="flex items-start gap-4 p-5 rounded-2xl"
                style={{ background: "#111113", border: "1px solid #1F1F23" }}>
          ...
          <div className="flex flex-col items-center gap-6 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-5">
              {[
                ...
                <Link key={href} href={href} className="text-sm hover:text-foreground transition-colors"
