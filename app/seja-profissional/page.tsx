    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      <section className="px-4 pt-10 pb-8"
        ...
        <div className="max-w-lg mx-auto text-center">
          ...
          {/* Headline */}
          <h1 className="font-syne font-extrabold text-2xl text-foreground leading-snug mb-3">
      ...
      <section className="px-4 py-8">
        <div className="max-w-lg mx-auto">
          ...
          <h2 className="font-syne font-extrabold text-xl text-foreground text-center mb-1">
              ...
              <div className="flex items-start justify-between mb-3 mt-1">
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-end gap-0.5">
                    <span className="font-syne font-extrabold text-2xl text-foreground">R$69</span>
            ...
            <div className="relative rounded-2xl p-5 overflow-hidden"
              ...
              <div className="flex items-start justify-between mb-3 mt-1">
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-end gap-0.5">
                    <span className="font-syne font-extrabold text-2xl text-white">R$99</span>
                    <span className="text-xs text-muted mb-0.5">/mês</span>
                  </div>
                </div>
              </div>
      ...
      <section className="px-4 py-8" style={{ borderTop: "1px solid #1F1F23" }}>
        <div className="max-w-lg mx-auto">
          ...
          <h2 className="font-syne font-extrabold text-xl text-foreground text-center mb-5">
            ...
            {[
              {
                ...
                desc: "Escolha o plano, pague via PIX e seu perfil fica ativo em minutos.",
              },
              {
                num: "02", icon: Users, color: "#a855f7",
                title: "Apareça nas buscas",
                desc: "Clientes buscam pelo seu serviço e encontram seu perfil com foto, avaliações e bairros atendidos.",
              },
              {
                num: "03", icon: MessageCircle, color: "#22c55e",
                title: "Receba no WhatsApp",
                desc: "O cliente clica em 'Chamar no WhatsApp' e fala direto com você. Sem intermediários. Sem taxa por contato.",
              },
      ...
      <section className="px-4 py-8" style={{ background: "#080809", borderTop: "1px solid #1F1F23" }}>
        <div className="max-w-lg mx-auto">
          ...
          <h2 className="font-syne font-extrabold text-xl text-foreground text-center mb-4">
      ...
      <section className="px-4 py-8" style={{ background: "#080809", borderTop: "1px solid #1F1F23" }}>
        <div className="max-w-lg mx-auto">
          ...
          <div className="space-y-2">
            {[
              {
                q: "Quando meu perfil fica visível?",
                a: "Assim que o pagamento via PIX for confirmado, seu perfil já aparece nas buscas. O processo leva menos de 5 minutos.",
              },
              {
                q: "Pago alguma taxa por cliente que me contatar?",
                a: "Não. Você paga apenas a assinatura mensal. Nenhuma taxa sobre contatos, orçamentos ou serviços realizados.",
              },
              {
                q: "Posso cancelar quando quiser?",
                a: "Sim, sem fidelidade e sem multa. Cancele pelo painel a qualquer momento. Seu perfil fica ativo até o final do período pago.",
              },
              {
                q: "Como os clientes chegam até mim?",
                a: "Clientes buscam pelo serviço no UDIHUB, veem seu perfil e clicam em 'Chamar no WhatsApp'. A conversa abre diretamente com você.",
              },
              {
                q: "Qual a diferença entre Básico e Pro?",
                a: "No Plano Pro você aparece antes dos perfis Básico nas buscas, tem badge de destaque e pode adicionar até 10 fotos. Mais visibilidade, mais clientes.",
              },
            ].map(({ q, a }) => (
