    ...
    <div className="min-h-screen bg-background pb-24">
      ...
      >
        ...
        <div className="max-w-lg mx-auto text-center relative z-10">
          ...
          <p className="text-muted text-sm sm:text-base leading-relaxed mb-8 max-w-sm mx-auto">
      ...
      <section className="px-4 py-10">
        <div className="max-w-lg mx-auto">
          <p className="text-xs font-bold tracking-widest mb-6 text-center" style={{ color: "#3B82F6" }}>
            COMO FUNCIONA
          </p>
      ...
      {/* Plans */}
      <section className="px-4 py-10" style={{ background: "#0A0A0E" }}>
        <div className="max-w-lg mx-auto">
          <p className="text-xs font-bold tracking-widest mb-2 text-center" style={{ color: "#3B82F6" }}>
            PLANOS
          </p>
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            >
              ...
              <Link
                href="/cadastro"
                className="block text-center py-3 rounded-xl font-bold text-sm text-white transition-all duration-200"
                style={{
                  background: "linear-gradient(135deg, #3B82F6, #1d4ed8)",
